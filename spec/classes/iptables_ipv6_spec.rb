...
describe 'iptables::ipv6' do
  ...
  it { 
    ...
    # ensure we've got our commit line, and that it is ordered properly
    should contain_concat__fragment('ip6tables-commit-line') \
      .with(
        { 'ensure' => 'present',
          'target' => '/etc/sysconfig/ip6tables',
          'order' => '9',
